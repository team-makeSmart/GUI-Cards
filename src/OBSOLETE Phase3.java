...
public class Phase3
{
   ...
   public static void main(String[] args)
   {
      ...
      myCardTable = new CardTable("High game ", NUM_CARDS_PER_HAND,
         NUM_PLAYERS);
   ...
   /**
    * Method allows for the computer to choose a card
    * 
    * @return int
    */
   ...
   /**
    * removes a card icon from the GUI
    * 
    * @param int
    *           playerID represents the player id
    * @param Card
    *           card object representing card
    * @param boolean
   ...
   private static void checkWinner()
   {
      ...
      Timer timer = new Timer(TWO_SECONDS, new ActionListener()
      {
         public void actionPerformed(ActionEvent e)
         {
            ...
            for (int i = 0; i < NUM_PLAYERS; i++)
            {
               String playedCardText = "<html><div style='text-align: "
                  + "center;'>" + playerNames[i] + "<br/>Score: " + score[i];
               cardPlayed[i] = null;
   ...
   private static void displayWinner()
   {
      ...
      {
         bottomPanel.add(new DisplayWinner(winner), BorderLayout.CENTER);
      }
   }
