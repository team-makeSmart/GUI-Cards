/**
 * Program reads the .gif image files as Icons, and attach them to JLabels that 
...
public class Phase1
{
   ...
   private static void loadCardIcons()
   {
      ...
      icon[NUM_CARD_IMAGES - 1] = new ImageIcon( inputFileName + "BK" + 
         fileExtension);
   }
   ...
   {
      int k; // To use as an index variable
